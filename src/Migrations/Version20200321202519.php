 ...
 */
final class Version20200321202519 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE admission DROP admission, CHANGE discharged discharged DATETIME DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE admission ADD admission DATETIME NOT NULL, CHANGE discharged discharged DATETIME DEFAULT \'NULL\'');
