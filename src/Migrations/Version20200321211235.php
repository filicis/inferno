 ...
 */
final class Version20200321211235 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE admission DROP INDEX UNIQ_F4BB024AA76ED395, ADD INDEX IDX_F4BB024AA76ED395 (user_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE admission DROP INDEX IDX_F4BB024AA76ED395, ADD UNIQUE INDEX UNIQ_F4BB024AA76ED395 (user_id)');
        $this->addSql('ALTER TABLE admission CHANGE discharged discharged DATETIME DEFAULT \'NULL\'');
