 ...
 */
final class Version20200322013037 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE afsnit (id INT AUTO_INCREMENT NOT NULL, sks VARCHAR(7) NOT NULL, navn VARCHAR(64) NOT NULL, oprettet DATE NOT NULL, beds LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', notefelter LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', kortnavn VARCHAR(8) NOT NULL, UNIQUE INDEX UNIQ_BC8C7322E6F39DF1 (sks), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
