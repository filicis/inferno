 ...
 */
final class Version20200321172338 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE admission (id INT AUTO_INCREMENT NOT NULL, cpr_id INT NOT NULL, sks_id INT NOT NULL, user_id INT NOT NULL, admission DATETIME NOT NULL, active TINYINT(1) NOT NULL, discharged DATETIME DEFAULT NULL, admitted DATETIME NOT NULL, UNIQUE INDEX UNIQ_F4BB024A9E4648AD (cpr_id), UNIQUE INDEX UNIQ_F4BB024A321C8BC0 (sks_id), UNIQUE INDEX UNIQ_F4BB024AA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE admisions (id INT AUTO_INCREMENT NOT NULL, cpr_id INT NOT NULL, sks_id INT NOT NULL, admission DATETIME NOT NULL, active TINYINT(1) NOT NULL, discharged DATETIME DEFAULT \'NULL\', UNIQUE INDEX UNIQ_B58F949B321C8BC0 (sks_id), UNIQUE INDEX UNIQ_B58F949B9E4648AD (cpr_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
