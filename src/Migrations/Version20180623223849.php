 ...
 */
final class Version20180623223849 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE afdeling (id INT AUTO_INCREMENT NOT NULL, sks VARCHAR(9) NOT NULL, navn VARCHAR(64) NOT NULL, is_active TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
