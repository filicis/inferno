 ...
 */
final class Version20200323001920 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE admission ADD bed VARCHAR(8) DEFAULT NULL, CHANGE discharged discharged DATETIME DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE admission DROP bed, CHANGE discharged discharged DATETIME DEFAULT \'NULL\'');
